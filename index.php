...
if (!empty($_SESSION['active'])) {
  ...
  Ingrese su usuario y su clave
      ...
      $query = mysqli_query($conexion, "SELECT u.id_usuario, u.nombre, u.usuario,r.id_rol,r.nombre_rol FROM usuario u INNER JOIN rol r ON u.id_rol = r.id_rol WHERE u.usuario = '$usuario' AND u.clave = '$clave'");
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login">
                <img src="sistema/img/logo_login.png" class="img-thumbnail">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Usuario" name="usuario" autocomplete="off"></div>
                    <div class="form-group">
                      <label for="">Contraseña</label>
                      <input type="password" class="form-control" placeholder="Contraseña" name="clave" autocomplete="off">
                    </div>
                    <center><button  type="submit" value="Iniciar" class="btn btn-primary"><i class="fas fa-user-shield"></i> Iniciar Sesión</button></center>
                    <hr>
                  </form>
                  <hr>
                </div>
