...
// OBTENEMOS LOS EXÁMENS DE HECES PARA LUEGO SER MODIFICADOS
$query = mysqli_query($conexion, "SELECT * FROM detalles_heces WHERE id_examen_creado=$id_examen_creado");
$result = mysqli_num_rows($query);
                        if ($result > 0) {
...
<table border="1" width="100%"><!-- TABLA BORDE GENERAL MARCO-->
<tr><td>
...
<tr>
    <td><b>Macroscópico<b></td><td></td><td></td><td></td></tr>
<tr>
<td>color</td><td id="uno"><?php  echo $color?></td><td>- - -</td><td>Café</td></tr>



<tr><td>Consistencia</td><td id="uno"><?php  echo $consistencia?></td><td>- - -</td><td>Pastoso/Formado</td></tr>
<tr><td>Ph</td><td id="uno"><?php  echo $ph?></td><td>- - -</td><td>6.-7</td></tr>

<tr>
<td>Sangre</td><td id="uno"><?php  echo $sangre?></td><td>- - -</td><td>No se observó</td></tr>
<tr><td>Moco</td><td id="uno"><?php  echo $moco?></td><td>- - -</td><td>No se observó</td></tr>


<tr><td>Restos Alimenticios</td><td id="uno"><?php  echo $restos_alimenticios?></td><td> - - -</td><td>Escasos / +</td></tr>

<tr>
    <td><b>Microscópico<b></td><td></td><td></td><td></td></tr>


<tr><td>Células Vegetales</td><td id="uno"><?php  echo $celulas_vegetales?></td><td>- - -</td><td>Escasos / +</td></tr>

<tr><td>Almidones</td><td id="uno"><?php  echo $almidones?></td><td>- - -</td><td>Escasos / +</td></tr>
<tr><td></td><td></td><td></td><td></td></tr>

<tr><td>Jabones</td><td id="uno"><?php  echo $jabones?></td><td> - - -</td><td>Escasos / +</td></tr>
<tr><td>Grasas</td><td id="uno"><?php  echo $grasas?></td><td> - - </td><td>Escasos / +</td></tr>
<tr><td>Levaduras</td><td id="uno"><?php  echo $levaduras?></td><td> - - </td><td>Escasos / +</td></tr>
<tr><td>Leucocitos</td><td id="uno"><?php  echo $leucocitos?></td><td>- - - </td><td>No se observaron</td></tr>
<tr><td>Eritrocitos</td><td id="uno"><?php  echo $eritrocitos?></td><td>- - -</td><td>No se observaron</td></tr>
