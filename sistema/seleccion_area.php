...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Seleccionar Área</h1>
...
<div class="col-lg-3">
    ...
    <input type="hidden" name="observaciones_muestra" value="<?php echo $observaciones_muestra=$_SESSION['observaciones_muestra'] ?>">
      ...
      <button type="submit" class="btn btn-primary-outline" style="color:white" name="crear_examen"><?php  echo $nombre_area= $encontrados_a['nombre_area']; ?></button>  
