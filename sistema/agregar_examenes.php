 ...
 <?php
    ...
    <div class="col-md-5" >
        ...
        <div class="col-md-3" >
          ...
          <a href="seleccion_area.php?id_paciente=<?php echo $id_paciente?>" class="btn btn-primary" style="background: #0e7180 "><i class="fas fa-arrow-circle-left" ></i> Regresar</a>
    <?php
    //CONDICIONAMOS SI ES EXÁMEN DEL CÓDIGO 501 PARA JALAR EL PDF DE ESE EXAMEN ESPECÍFICO
if(isset($examenes_agregados))
       {
      foreach ($examenes_agregados as $agregado) {

                $codigo_examen_agregado=$agregado['codigo_examen'];
...
<div class="col-md-4 alert alert-success" >
    <a href="pdf_formulario.php?id_examen_creado=<?php echo $id_examen_creado ?>"><button class="btn btn-primary" type="submit" name="pdf_constancia" style="background:   #e8f4f8;color: black;   "><i class="far fa-file-pdf" style="color:black;font-size: 20px;"></i> Formulario</button></a>
...
<?php
 ...
 <div class="card">
              ...
              if(isset($examenes_formulario))
              {
                                      foreach ($examenes_formulario as $examenes_encontrados) {
                                ...
                                <?php  $valor_referencia=$examenes_encontrados['valor_referencia'] ?>
                                   <?php  $valor_referencia2=$examenes_encontrados['valor_referencia2'] ?>
...
<div class="col-lg-12">
       ...
       <input type="hidden" class="form-control"  name="id_examen" id="id_examen" autocomplete="" required="" readonly="" value="<?php echo $id_examen ?>"> 
           ...
           <input type="hidden" class="form-control"  name="codigo_examen" id="codigo_examen" autocomplete="" required="" readonly="" value="<?php echo $codigo_examen ?>">                      
...
<div class="form-group row"> 
            ...
            <div class="col-md-12" >
<center>
                <strong style="font-size:25px"><?php echo $nombre_examen ?></strong></center>
                    ...
                    <input type="hidden" class="form-control" placeholder="Valor de Referencia" name="valor_referencia" id="valor_referencia" autocomplete=""  required="" readonly="" value="<?php echo $valor_referencia."-".$valor_referencia2. " ".$nombre_nomenclatura ?>">
                </div>
...
<button  type="submit" value="" class="btn btn-success" name="agregar_examenes_orina"><i class="fas fa-vial"></i> Confirmar</button>
...
<button  type="submit" value="" class="btn btn-success" name="agregar_examenes_hematologia"><i class="fas fa-vial"></i> Confirmar</button>
...
<button  type="submit" value="" class="btn btn-success" name="agregar_examenes_heces"><i class="fas fa-vial"></i> Confirmar</button>
...
<button  type="submit" value="" class="btn btn-success" name="agregar_examenes_cultivos"><i class="fas fa-vial"></i> Confirmar</button>
...
else
{
         ...
         ?>
                <button  type="submit" value="" class="btn btn-primary" name="agregar_examenes_formulario"><i class="fas fa-vial"></i> Confirmar</button>
    <?php  
...
if($tec_encontrados['id_rol']!=3)  // es el número de ID asignado de forma manual desde la BD
{
...
if(isset($tecnico_asignado))
                           ...
                           foreach ($tecnico_asignado as $encontrados_a)
                            {
                                $id_usuario_tecnico=$encontrados_a['id_usuario_tecnico'];
                                $nombre_tecnico_asignado=$encontrados_a['usuario'];
...
<input type="hidden" name="observaciones_generales" id="observaciones_generales" value="">

                                
<input type="hidden" name="id_usuario_tecnico" required="" value="<?php echo $id_usuario_tecnico?>">
            <div class="col-md-3" >
 ...
 if(($estado_examen_creado==1))
{
    ...
    ?>   
<button class="btn btn-primary" type="submit" name="finalizar_agregado_formulario" style="background: #5b0532 "><i class="fas fa-save"></i> Finalizar</button>
<?php
}
}  
?>
            ...
            <div class="col-md-5" >
<?php  echo "Referido: ". (isset($nombre_medico)? $nombre_medico:"No")?>

</div>

            <div class="col-md-3" >
<?php  echo "Técnico: ".$nombre_tecnico_asignado?>
...
<tr>
  <td><?php echo $fila=$fila+1;  ?></td>
      ...
      <td><?php echo $agregado['resultado'] ?></td>
      <td><?php echo $agregado['valor_referencia']." - ".$agregado['valor_referencia2']." ".$agregado['nombre_nomenclatura']  ?></td>
      <td>
...
{
        ?>
        <a href="modelo_eliminar.php?id_detalle_examen=<?php echo $agregado['id_detalle_examen'] ?>"><i class="fas fa-backspace" style="color:red"></i></a>
...
<textarea name="observaciones_generales" value="" id="observaciones_generales_pasa" placeholder="Observaciones" onkeyup="pasar_observaciones();"></textarea> 
...
function pasar_observaciones(){
   ...
   document.getElementById("observaciones_generales").value = document.getElementById("observaciones_generales_pasa").value;
}
