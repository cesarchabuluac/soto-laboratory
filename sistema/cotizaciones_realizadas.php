...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Cotizaciones Realizadas</h1>
            ...
            <div class="table-responsive">
                ...
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" style="color:black;font-size: 15px;font-family: inherit;">
                    ...
                    <tbody style="font-size:13px">
                        <?php
                        $fila = 0;
                        if (isset($cotizaciones_creadas)) {
                            foreach ($cotizaciones_creadas as  $encontrados) {
                                $fila++
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <a href="pdf_formulario_cotizacion.php?id_examen_creado=<?php echo $id_examen_creado = $encontrados['id_examen_creado']; ?>">
                                                    <i class="fas fa-receipt" style="font-size: 30px; color: green;"></i></a>
