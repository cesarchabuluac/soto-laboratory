...
<div class="col-md-6" >
                    ...
                    <select  class="form-control" placeholder="Médico Referido" name="id_medico_referido" required="">
...
<div class="col-md-6" >
                   ...
                   <label for="nombre">Seleccione Técnico</label>
                    <select type="text" class="form-control" placeholder="id usuario técnico" name="id_usuario_tecnico" id="id_usuario_tecnico"required="" onclick="crear_formulario()">
  <option selected value="">Seleccionar Técnico</option>
...
<option value="<?php  echo $encontrados['id_usuario'] ?>"><?php  echo $encontrados['nombre'] ?></option>
<?php } 
...
<input  name="actualizar_paciente_reporte" type="submit" class="btn btn-danger"  id="reportar_muestra" value="No Procesado" onclick= "document.form1.action = 'modelo_guardar.php'; 
 ...
 <button class="btn btn-primary" type="submit" class="btn btn-primary-outline" style="color: white" name="actualizar_paciente_formulario" onclick= "document.form1.action = 'modelo_guardar.php'; 
    document.form1.submit()"  value="Crear Formulario"> <i class="fas fa-flask" style="font-size:40px"></i> Crear Formulario</button>
